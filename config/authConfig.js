...
export const msalConfig = {
  auth: {
    ...
    redirectUri: typeof window !== 'undefined' ? window.location.origin : 'https://agreeable-water-0cc1ed70f.1.azurestaticapps.net',
    knownAuthorities: ['robotrekerai.ciamlogin.com'],
    validateAuthority: false,
    // CIAM-specific settings for external users
    postLogoutRedirectUri: typeof window !== 'undefined' ? window.location.origin : 'https://agreeable-water-0cc1ed70f.1.azurestaticapps.net',
